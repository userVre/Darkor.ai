...
type StyleCardBadgeTone = "blue" | "green" | "violet";
    ...
    <View style={{ width, marginBottom: spacing.sm, marginRight: index % 2 === 0 ? 12 : 0 }}>
      ...
      >
        ...
        {showNewBadge ? (
          ...
          >
            <Text style={{ color: "#A4161A", fontSize: 10, fontWeight: "800", letterSpacing: 0, textTransform: "uppercase" }}>
...
const INTERIOR_EXAMPLE_PHOTOS: ExamplePhoto[] = [
  ...
  },
  {
    ...
    label: "Empty Kitchen",
    source: require("../../assets/media/examples/interior/interior-before-empty-kitchen.webp"),
  },
  {
...
const EXTERIOR_EXAMPLE_PHOTOS: ExamplePhoto[] = [
  {
    ...
    source: require("../../assets/media/examples/exterior/exterior-before-scaffold-house.webp"),
  },
  {
    id: "exterior-before-weathered-house",
    label: "Weathered House",
    source: require("../../assets/media/examples/exterior/exterior-before-weathered-house.webp"),
  },
  {
    id: "exterior-before-brick-shell",
    label: "Brick Shell",
    source: require("../../assets/media/examples/exterior/exterior-before-brick-shell.webp"),
  },
  {
    id: "exterior-before-overgrown-cottage",
    label: "Overgrown Cottage",
    source: require("../../assets/media/examples/exterior/exterior-before-overgrown-cottage.webp"),
  },
  {
    id: "exterior-before-abandoned-home",
    label: "Abandoned Home",
    source: require("../../assets/media/examples/exterior/exterior-before-abandoned-home.webp"),
  },
  {
    id: "exterior-before-concrete-frame",
    label: "Concrete Frame",
    source: require("../../assets/media/examples/exterior/exterior-before-concrete-frame.webp"),
  },
];
...
const GARDEN_EXAMPLE_PHOTOS: ExamplePhoto[] = [
  {
    ...
    label: "Muddy Yard",
    source: require("../../assets/media/examples/garden/garden-before-muddy-yard.webp"),
  },
  {
    id: "garden-before-weedy-yard",
    label: "Weedy Yard",
    source: require("../../assets/media/examples/garden/garden-before-weedy-yard.webp"),
  },
  {
    id: "garden-before-rubble-yard",
    label: "Rubble Yard",
    source: require("../../assets/media/examples/garden/garden-before-rubble-yard.webp"),
  },
  {
    id: "garden-before-overgrown-corner",
    label: "Overgrown Corner",
    source: require("../../assets/media/examples/garden/garden-before-overgrown-corner.webp"),
  },
  {
    id: "garden-before-abandoned-backyard",
    label: "Abandoned Yard",
    source: require("../../assets/media/examples/garden/garden-before-abandoned-backyard.webp"),
  },
  {
    id: "garden-before-cracked-patio",
    label: "Cracked Patio",
    source: require("../../assets/media/examples/garden/garden-before-cracked-patio.webp"),
  },
];
...
const DEFAULT_SPACE_IMAGE = require("../../assets/media/discover/home/home-study.webp");
...
const EXTERIOR_STYLE_LIBRARY: ExteriorStyleItem[] = [
  ...
  },
  {
    ...
    image: require("../../assets/media/styles/style-exterior-brutalist.webp"),
    icon: Building2,
    eyebrow: "Sculptural",
  },
  {
    ...
    image: require("../../assets/media/styles/style-exterior-gothic.webp"),
    icon: BadgeCheck,
    eyebrow: "Dramatic",
  },
  {
  ...
  },
  {
    ...
    image: require("../../assets/media/styles/style-neo-classic-alt.webp"),
    icon: Building2,
    eyebrow: "Editorial",
  },
];
...
const CUSTOM_STYLE_COLLAGE_IMAGES = [
  require("../../assets/media/styles/style-modern.webp"),
  require("../../assets/media/styles/style-japandi.webp"),
  require("../../assets/media/styles/style-luxury.webp"),
  require("../../assets/media/styles/style-mediterranean.webp"),
] as const;

const STYLE_PREVIEW_OUTPUTS: Record<string, number> = {
  modern: require("../../assets/media/styles/style-modern.webp"),
  luxury: require("../../assets/media/styles/style-luxury.webp"),
  japandi: require("../../assets/media/styles/style-japandi.webp"),
  cyberpunk: require("../../assets/media/styles/style-cyberpunk.webp"),
  tropical: require("../../assets/media/styles/style-tropical.webp"),
  minimalist: require("../../assets/media/styles/style-minimalist.webp"),
  scandinavian: require("../../assets/media/styles/style-scandinavian.webp"),
  bohemian: require("../../assets/media/styles/style-bohemian.webp"),
  midcentury: require("../../assets/media/styles/style-midcentury.webp"),
  "art-deco": require("../../assets/media/styles/style-art-deco.webp"),
  coastal: require("../../assets/media/styles/style-coastal.webp"),
  rustic: require("../../assets/media/styles/style-rustic.webp"),
  vintage: require("../../assets/media/styles/style-vintage.webp"),
  mediterranean: require("../../assets/media/styles/style-mediterranean.webp"),
  glam: require("../../assets/media/styles/style-glam.webp"),
  "coastal-retreat": require("../../assets/media/styles/style-coastal-alt.webp"),
  "rustic-manor": require("../../assets/media/styles/style-rustic-alt.webp"),
  "hollywood-regency": require("../../assets/media/styles/style-hollywood-regency.webp"),
  "hollywood-regency-noir": require("../../assets/media/styles/style-hollywood-regency-alt.webp"),
  "neo-classic": require("../../assets/media/styles/style-neo-classic.webp"),
  "neo-classical": require("../../assets/media/styles/style-neo-classic-alt.webp"),
  "shabby-chic": require("../../assets/media/styles/style-shabby-chic.webp"),
  "french-country": require("../../assets/media/styles/style-french-country.webp"),
  brutalist: require("../../assets/media/styles/style-brutalist.webp"),
  "art-nouveau": require("../../assets/media/styles/style-art-nouveau.webp"),
  gothic: require("../../assets/media/styles/style-vintage.webp"),
  italianate: require("../../assets/media/styles/style-french-country.webp"),
  chinese: require("../../assets/media/styles/style-art-nouveau.webp"),
  zen: require("../../assets/media/styles/style-japandi.webp"),
  custom: require("../../assets/media/styles/style-luxury.webp"),
};
  ...
  switch (tone) {
    case "blue":
      return {
        ...
        backgroundColor: "rgba(0,86,214,0.84)",
        textColor: "#EAF6FF",
      };
    case "green":
      return {
...
const PALETTE_OPTIONS: PaletteOption[] = [
  {
    id: "surprise",
    label: "Curated Mix",
    colors: ["#f7f7f5", "#f4d7a6", "#fd5d82", "#6b8afd", "#111827"],
...
const ROOM_CARD_META: Record<string, RoomCardMeta> = {
  "Living Room": {
    ...
    image: require("../../assets/media/discover/home/home-living-room.webp"),
  },
  Bedroom: {
    icon: BedDouble,
    description: "A calmer, hotel-like retreat.",
    image: require("../../assets/media/discover/home/home-master-suite.webp"),
  },
  Kitchen: {
    icon: CookingPot,
    description: "Sharper culinary flow and finishes.",
    image: require("../../assets/media/discover/home/home-kitchen.webp"),
  },
  Bathroom: {
    icon: Bath,
    description: "Spa-driven comfort and texture.",
    image: require("../../assets/media/discover/home/home-bathroom.webp"),
  },
  "Home Office": {
    icon: Monitor,
    description: "Focused executive atmosphere.",
    image: require("../../assets/media/discover/home/home-home-office.webp"),
  },
  "Dining Room": {
  ...
  Nursery: {
    ...
    image: require("../../assets/media/rooms/room-nursery.webp"),
  },
  "Home Theater": {
    icon: Projector,
    description: "Immersive cinematic ambiance.",
    image: require("../../assets/media/rooms/room-home-theater.webp"),
  },
  "Gaming Room": {
    icon: Monitor,
    description: "Sharper play-and-stream atmosphere.",
    image: require("../../assets/media/discover/home/home-gaming-room.webp"),
  },
  Hall: {
    icon: DoorOpen,
    description: "An elevated transition space with presence.",
    image: require("../../assets/media/discover/home/home-hall.webp"),
  },
  Library: {
    icon: BookOpen,
    description: "Collected calm with tailored warmth.",
    image: require("../../assets/media/discover/home/home-library.webp"),
  },
  Laundry: {
    icon: Sparkles,
    description: "Utility upgraded with boutique order.",
    image: require("../../assets/media/discover/home/home-laundry.webp"),
  },
  House: {
    icon: House,
  ...
  Villa: {
    ...
    image: require("../../assets/media/discover/exterior/exterior-pool-house.webp"),
  },
  Apartment: {
    icon: Building2,
    description: "Refined urban facade refresh.",
    image: require("../../assets/media/discover/exterior/exterior-apartment-block.webp"),
  },
  "Office Building": {
    icon: Building2,
    description: "Sharper executive frontage.",
    image: require("../../assets/media/discover/exterior/exterior-glass-office.webp"),
  },
  Retail: {
    icon: Store,
    description: "Street-facing brand appeal.",
    image: require("../../assets/media/discover/exterior/exterior-retail-storefront.webp"),
  },
  Residential: {
    icon: CarFront,
    description: "Elevated home exterior character.",
    image: require("../../assets/media/discover/exterior/exterior-stone-manor.webp"),
  },
  Backyard: {
    icon: Trees,
    description: "Outdoor entertaining retreat.",
    image: require("../../assets/media/discover/garden/garden-backyard.webp"),
  },
  "Front yard": {
    icon: Fence,
    description: "First-impression landscaping.",
    image: require("../../assets/media/discover/garden/garden-front-yard.webp"),
  },
  Patio: {
    icon: SunMedium,
  ...
  Pool: {
    ...
    image: require("../../assets/media/discover/garden/garden-swimming-pool.webp"),
  },
  Terrace: {
    icon: DoorOpen,
    description: "Elevated lounge with a view.",
    image: require("../../assets/media/discover/garden/garden-terrace.webp"),
  },
  Deck: {
    icon: Fence,
    description: "Refined open-air lounge platform.",
    image: require("../../assets/media/discover/garden/garden-deck.webp"),
  },
} as const;
  ...
  return (
    <View style={{ marginTop: spacing.md, gap: spacing.sm }}>
      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
        <Text style={{ color: "#d4d4d8", fontSize: 11, fontWeight: "700", letterSpacing: 0, textTransform: "uppercase" }}>
          Before
        </Text>
        <MoveHorizontal color={active ? "#ffffff" : "#a1a1aa"} size={15} strokeWidth={2} />
        <Text style={{ color: active ? "#ffffff" : "#d4d4d8", fontSize: 11, fontWeight: "700", letterSpacing: 0, textTransform: "uppercase" }}>
          {mode.previewLabel}
        </Text>
      </View>
...
export default function WorkspaceScreen() {
  ...
  const markFirstDiamondRatingPrompted = useMutation("users:markFirstDiamondRatingPrompted" as any);
  ...
  const [pendingReviewState, setPendingReviewState] = useState<{
    ...
    shouldPromptFirstDiamondRating?: boolean;
  } | null>(null);
  ...
  const firstDiamondRatingHandledRef = useRef(false);
  ...
  const displayedStyleCards = useMemo<DisplayStyleCard[]>(() => {
    ...
    const aiSuggestCard: DisplayStyleCard = {
      ...
      description: isAiSuggesting
        ...
        : "Let GPT-4o automatically pick the best style based on the room's lighting and structure.",
      image: null,
      icon: Wand2,
      eyebrow: "Smart",
      isCustom: false,
  ...
  const gardenStyleGalleryCards = useMemo(
    () => [
      ...
      },
      {
        ...
        image: require("../../assets/media/discover/garden/garden-villa-entry.webp"),
      },
      {
        id: "modern",
        title: "Modern",
      ...
      },
      {
        ...
        image: require("../../assets/media/discover/garden/garden-patio.webp"),
      },
      {
        id: "vintage",
        title: "Vintage",
      ...
      },
      {
        ...
        image: require("../../assets/media/discover/garden/garden-pool-courtyard.webp"),
      },
    ],
    [i18n.language, t],
  );
  ...
  useEffect(() => {
    ...
    if (currentGenerationStatus === "ready" && hasResultImage) {
      ...
      if (pendingReviewState) {
        ...
        if (pendingReviewState.shouldPromptFirstDiamondRating && !firstDiamondRatingHandledRef.current) {
          firstDiamondRatingHandledRef.current = true;
          requestAnimationFrame(() => {
            void (async () => {
              await requestStoreReview();
              await markFirstDiamondRatingPrompted({ anonymousId: viewerId ?? undefined });
            })().catch(() => undefined);
          });
        } else if (pendingReviewState.shouldPrompt) {
    ...
    isGenerating,
    isProcessingGateActive,
    markFirstDiamondRatingPrompted,
    pendingReviewState,
    posthog,
    processingGateUntil,
    requestNotificationsAfterReveal,
        ...
        <AnimatePresence>
          {showRefineStickyLabel ? (
            ...
            >
              ...
              >
                <Text style={{ color: "rgba(255,255,255,0.54)", fontSize: 12, fontWeight: "700", letterSpacing: 0 }}>
                              ...
                              >
                                <View style={{ flex: 1 }}>
                                  ...
                                  <View style={{ flex: 1, gap: spacing.sm, paddingHorizontal: spacing.md, paddingTop: spacing.md, paddingBottom: spacing.md, alignItems: "flex-start" }}>
                                    <Text style={{ color: "#ffffff", fontSize: 20, fontWeight: "700", letterSpacing: 0, textAlign: "left" }}>
                                      {item.title}
                                    </Text>
                  ...
                  isPaintService ? (
                    <>
                      ...
                      <View style={{ gap: spacing.lg }}>
                        ...
                        >
                          <Text style={{ color: "#ffffff", fontSize: 15, fontWeight: "700", letterSpacing: 0 }}>
                            Couleur du mur
                          </Text>
                          <View
                            style={{
                      ...
                      <View style={wizardCenteredGridStyle}>
                        <MotiView {...staggerFadeUp(0, 20)} style={{ width: wizardCardWidth }}>
                          ...
                          >
                            ...
                            <View style={{ gap: spacing.sm }}>
                              <Text style={{ color: "#ffffff", fontSize: 18, fontWeight: "700", letterSpacing: 0 }}>
                                Choix de l'IA
                              </Text>
                            ...
                            <MotiView key={material.id} {...staggerFadeUp(index + 1, 24)} style={{ width: isFullWidthMaterialCard ? "100%" : wizardCardWidth }}>
                              ...
                              >
                                ...
                                <View style={{ gap: spacing.sm, alignItems: "flex-start" }}>
                                  <Text style={{ color: "#ffffff", fontSize: 18, fontWeight: "700", letterSpacing: 0, textAlign: "left" }}>
                                    {material.title}
                                  </Text>
                    ...
                    <>
                      ...
                      {showStyleScrollCue ? (
                        ...
                        >
                          <Text style={{ color: "rgba(255,255,255,0.58)", fontSize: 11, fontWeight: "700", letterSpacing: 0, textTransform: "uppercase" }}>
                            Scroll for more
                          </Text>
                            ...
                            <MotiView key={style.id} {...staggerFadeUp(index, 22)} style={{ width: isFullWidthStyleCard ? "100%" : wizardCardWidth }}>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <Text style={{ color: "#ffffff", fontSize: 16, fontWeight: "700", lineHeight: 22, letterSpacing: 0, textAlign: "left" }} numberOfLines={2}>
                                    {style.title}
                                  </Text>
                                  ...
                                  {isFullWidthStyleCard ? (
                                    <Text style={{ color: "rgba(255,255,255,0.5)", fontSize: 11, fontWeight: "600", letterSpacing: 0, textTransform: "uppercase" }}>
                                      Final option
                                    </Text>
                                  ) : null}
                                </View>
                  ...
                  isPaintService || isFloorService ? (
                    <>
                      ...
                      >
                        ...
                        >
                          <Text style={{ color: "#ffffff", fontSize: 23, fontWeight: "700", letterSpacing: 0 }}>
                            {isPaintService
                        ...
                        <View style={{ gap: spacing.sm }}>
                          <Text style={{ color: "#ffffff", fontSize: 22, fontWeight: "700", letterSpacing: 0 }}>Finish Type</Text>
                          <View style={{ gap: spacing.sm }}>
      ...
      : breakLongWizardDescription("Review your exterior selections, then generate instantly. Sign in later to preserve it in My Design Portfolio.")}
                      ...
                      >
                        ...
                        <View style={{ paddingHorizontal: spacing.md, paddingTop: spacing.md, paddingBottom: spacing.md, gap: spacing.md }}>
                          <View style={{ gap: spacing.sm }}>
                            <Text style={{ color: "#ffffff", fontSize: 22, fontWeight: "700", letterSpacing: 0 }}>
                          ...
                          >
                            ...
                            <View style={{ position: "absolute", left: 10, right: 10, bottom: 10 }}>
                              <View style={{ alignSelf: "flex-start", borderRadius: 999, backgroundColor: "rgba(255,255,255,0.14)", paddingHorizontal: spacing.sm, paddingVertical: spacing.xs }}>
                                <Text style={{ color: "#ffffff", fontSize: 10, fontWeight: "700", letterSpacing: 0, textTransform: "uppercase" }}>
                                  Preview
                                </Text>
                              </View>
                            </View>
                    ...
                    <>
                      ...
                      <View style={{ gap: spacing.sm, width: "100%", maxWidth: wizardGridMaxWidth, alignSelf: "center" }}>
                        <Text style={{ color: "#ffffff", fontSize: 22, fontWeight: "700", letterSpacing: 0 }}>{t("wizard.interior.stepFourMode")}</Text>
                        <Text style={{ color: wizardMutedTextColor, fontSize: 14, lineHeight: 22 }}>
                      ...
                      >
                        <Text style={{ color: "#ffffff", fontSize: 22, fontWeight: "700", letterSpacing: 0 }}>{t("wizard.interior.stepFourPalette")}</Text>
                              ...
                              <MotiView key={palette.id} {...staggerFadeUp(index, 18)} style={{ width: isFullWidthPaletteCard ? "100%" : wizardPaletteCardWidth }}>
                                ...
                                >
                                  ...
                                  {isPopular ? (
                                    ...
                                    >
                                      <Text style={{ color: "#DCFCE7", fontSize: 10, fontWeight: "800", letterSpacing: 0 }}>
                                        POPULAR
                                      </Text>
                                    </View>
                                  ) : null}
                              ...
                              >
                                ...
                                <View style={{ position: "absolute", left: 10, right: 10, bottom: 10 }}>
                                  <View style={{ alignSelf: "flex-start", borderRadius: 999, backgroundColor: "rgba(0,0,0,0.44)", borderWidth: 1, borderColor: "rgba(17,24,39,0.30)", paddingHorizontal: spacing.sm, paddingVertical: spacing.xs }}>
                                    <Text style={{ color: "#ffffff", fontSize: 10, fontWeight: "700", letterSpacing: 0 }} numberOfLines={2}>
          ...
          >
            ...
            >
              <View style={{ gap: spacing.xs }}>
                <Text style={{ color: "#ffffff", fontSize: 22, fontWeight: "700", letterSpacing: 0 }}>Paint Tutorial</Text>
        ...
        {isPaintService && paintColorPickerOpen ? (
          ...
          >
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                <View>
                  <Text style={{ color: "#ffffff", fontSize: 22, fontWeight: "700", letterSpacing: 0 }}>Color Picker</Text>
              ...
              <View style={{ gap: spacing.sm }}>
                <Text style={{ color: "#d4d4d8", fontSize: 12, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0 }}>Custom Hex</Text>
                <TextInput
        ...
        {isPaintService && paintSurfacePickerOpen ? (
          ...
          >
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                <Text style={{ color: "#ffffff", fontSize: 22, fontWeight: "700", letterSpacing: 0 }}>Surface Type</Text>
        ...
        <FlashList
          ...
          ListHeaderComponent={
            <View style={{ marginBottom: spacing.lg }} className="flex-row items-center justify-between">
              <View style={{ width: 42 }} />
                  <Text style={{ color: "#ffffff", fontSize: 22, fontWeight: "700", letterSpacing: 0 }}>My Design Portfolio</Text>
              <LuxPressable
        ...
        <View style={{ flex: 1, backgroundColor: "#FFFFFF" }}>
          ...
          <View className="px-5" style={{ paddingTop: Math.max(insets.top + 14, 22), zIndex: 2 }}>
            <View style={{ minHeight: 46, alignItems: "center", justifyContent: "center" }}>
              <Text style={{ color: "#111111", fontSize: 19, lineHeight: 25, letterSpacing: 0, textAlign: "center", ...fonts.bold }}>
                {t("processing.title")}
              </Text>
            </View>
          ...
          >
            <View style={{ flex: 1, justifyContent: "flex-start", gap: 18, paddingTop: 4, transform: [{ translateY: -52 }] }}>
              <View style={{ alignItems: "center", gap: 6 }}>
                ...
                >
                  <Text style={{ color: "#4A5562", fontSize: 11, lineHeight: 14, letterSpacing: 0, textTransform: "uppercase", ...fonts.bold }}>
              ...
              >
                <Text style={{ color: "#9CA3AF", fontSize: 11, lineHeight: 14, letterSpacing: 0, textTransform: "uppercase", textAlign: "center", ...fonts.medium }}>
                  HomeDecor AI
                </Text>
                ...
                >
                  ...
                  <View style={{ position: "absolute", left: 16, right: 16, top: 16, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                    <View style={{ borderRadius: 999, borderWidth: 1, borderColor: "#111111", backgroundColor: "#FFFFFF", paddingHorizontal: spacing.sm, paddingVertical: spacing.sm }}>
                      <Text style={{ color: "#000000", fontSize: 11, lineHeight: 14, letterSpacing: 0, textTransform: "uppercase", ...fonts.semibold }}>
