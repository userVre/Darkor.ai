...
const styles = StyleSheet.create({
  ...
  tipLabel: { color: SERVICE_WIZARD_THEME.colors.accentText, fontSize: 11, fontWeight: "800", letterSpacing: 0.3, textTransform: "uppercase" },
  ...
  summaryLabel: { color: SERVICE_WIZARD_THEME.colors.accentText, fontSize: 11, fontWeight: "800", letterSpacing: 0.3, textTransform: "uppercase" },
  summaryTitle: { color: "#ffffff", fontSize: 22, fontWeight: "800", letterSpacing: 0.3 },
  ...
  resultHeading: { color: "#ffffff", fontSize: 28, fontWeight: "800", letterSpacing: 0.3, textAlign: "left" },
