...
const styles = StyleSheet.create({
  ...
  topTitle: { color: "#ffffff", fontSize: 19, fontWeight: "800", letterSpacing: 0 },
  ...
  tipLabel: { color: SERVICE_WIZARD_THEME.colors.accentText, fontSize: 11, fontWeight: "800", letterSpacing: 0, textTransform: "uppercase" },
  ...
  summaryLabel: { color: SERVICE_WIZARD_THEME.colors.accentText, fontSize: 11, fontWeight: "800", letterSpacing: 0, textTransform: "uppercase" },
  summaryTitle: { color: "#ffffff", fontSize: 22, fontWeight: "800", letterSpacing: 0 },
  ...
  resultHeading: { color: "#ffffff", fontSize: 28, fontWeight: "800", letterSpacing: 0, textAlign: "left" },
