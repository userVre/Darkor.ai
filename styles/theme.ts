...
function createTheme(palette: typeof lightPalette) {
  return {
    ...
    surfaceSelected: palette.ruby.ruby3,
    ...
    brand: palette.ruby.ruby9,
    brandDark: palette.ruby.ruby10,
    brandSoft: palette.ruby.ruby4,
    brandSurface: palette.ruby.ruby3,
    brandSurfaceHigh: palette.ruby.ruby4,
    brandBorder: palette.ruby.ruby9,
    brandBorderStrong: palette.ruby.ruby10,
